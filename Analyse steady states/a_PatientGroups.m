%% Script to analyse what type of stable state each skin site has
% Assign site to specific number (1 - 9) based on categories outlined in
...
parfor i = 1:length(AllVirtualPatients)
