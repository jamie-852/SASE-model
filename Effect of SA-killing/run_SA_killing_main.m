...
g_TreatmentResponse(0, 1, 5, 1, 0.5, 4, 'main');
...
fprintf('═══════════════════════════════════════════════════════\n');
fprintf('\nOutput files:\n');
fprintf('  → figures/Figure3_AllSites.png\n');
fprintf('  → figures/Figure3_Reversible.png\n');
fprintf('  → figures/Figure3_Irreversible.png\n\n');