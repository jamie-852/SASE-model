...
g_TreatmentResponse(0, 2, 10, 2, 2, 50, 'supp');
...
fprintf('═══════════════════════════════════════════════════════\n');
fprintf('\nOutput files:\n');
fprintf('  → figures/FigureS2_AllSites.png\n');
fprintf('  → figures/FigureS2_Reversible.png\n');
fprintf('  → figures/FigureS2_Irreversible.png\n\n');