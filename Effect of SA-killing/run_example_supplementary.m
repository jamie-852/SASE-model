...
%
% This script analyses ONE example reversible patient at a finer resolution
% to demonstrate the narrow therapeutic window for successful treatment.
%
% Prerequisites:
%   - Must have run g_ExtractInitialConditions.m (part of run_SA_killing_main.m)
...
%
% Outputs:
%   - figures/FigureS3_PhasePortrait.png (shows ALL steady states)
%   - data/example_site_results.csv (detailed treatment results grid)
%   - figures/FigureS3_TreatmentResponse.png (treatment heatmap)
%
% Usage:
%   matlab -batch "run('run_example_supplementary.m')"
%
% Author: Jamie Lee
...
fprintf('  → figures/FigureS3_PhasePortrait.png\n');
...
fprintf('  → figures/FigureS3_TreatmentResponse.png\n');
